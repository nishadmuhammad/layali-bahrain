...
@section('canonical','https://mapletechspace.com/services/it-consulting')
@endif
...
@section('canonical','https://mapletechspace.com/services/branding')
@endif
...
@section('canonical','https://mapletechspace.com/services/digital-marketing')
@endif
...
@section('canonical','https://mapletechspace.com/services/social-media-marketing')
@endif
@if($service->slug=='search-engine-optimization')
@section('description','At Maple Tech Space, we take care of all your business concerns regarding SEO and make sure that your Website appears on the first page of Google results.')
...
@section('canonical','https://mapletechspace.com/services/search-engine-optimization')
@endif
...
@section('canonical','https://mapletechspace.com/services/website-design-and-development')
@endif
...
@section('canonical','https://mapletechspace.com/services/android-and-ios-development')
@endif
...
@section('canonical','https://mapletechspace.com/services/custom-software-development')
@endif
@section('ogImage','')
